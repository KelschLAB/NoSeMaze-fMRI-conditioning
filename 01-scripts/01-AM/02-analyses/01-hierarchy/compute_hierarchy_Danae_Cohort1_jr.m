%% compute_hierarchy_Danae_Cohort1_jr.m
...
data_path = '/zi-flstorage/data/Jonathan/ICON_Autonomouse/04-outputs/01-AM/05-Danae/Cohort_1/tubetest'; % adapted JR, 17.01.2023
...
save(fullfile(data_path,['DS_info_DanaeCoh1_day' num2str(include_days(1)) 'to' num2str(include_days(end)) '_' num2str(sum(matrix_index_include)) 'mice_withChasing.mat']),'DS_info','DS_info_chasing');
