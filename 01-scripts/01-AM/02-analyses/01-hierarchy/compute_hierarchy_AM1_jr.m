...
save(fullfile(data_path,['DS_info_AM1_day' num2str(include_days(1)) 'to' num2str(include_days(end)) '_' num2str(sum(matrix_index_include)) 'mice_withChasingAndDoubleChasing_thresh' num2str(time_threshold) '.mat']),'DS_info','DS_info_chasing','DS_info_double_chasing');
...
% 
figure;
scatter(DS_info_chasing.DS,DS_info_double_chasing.DS);
axis square
ax=gca;
ax.YLabel.String = {['double chasing: ' num2str(time_threshold) 's'],'Davids score'};
ax.XLabel.String = {['following'],'Davids score'};
lsline;
text(1,1,['r=' num2str(corr(DS_info_chasing.DS',DS_info_double_chasing.DS'))]);
...
% 
figure;
scatter(DS_info.DS,DS_info_double_chasing.DS);
axis square
ax=gca;
ax.YLabel.String = {['double chasing: ' num2str(time_threshold) 's'],'Davids score'};
ax.XLabel.String = {['SH'],'Davids score'};
lsline;
