...
exportgraphics(gcf, fullfile(save_dir,'chasing_events_over_daytime_both_AM_combined_all_events.pdf'),'ContentType','vector','BackgroundColor','none');
close all;

% export source data
writetable(array2table(collect_daytime),fullfile(save_dir,'chasing_events_over_daytime_both_AM_combined_all_events_source.xlsx'));
