function [R,T,EPI]=scrubbing_jr(fdir,T,threshold,method,outpref)


prefix='wave_10cons_med1000new_msk_s6_wrst_a1_u_despiked_del5_';

EPI=spm_select('FPList',[fdir,filesep,'wavelet'],strcat('^',prefix,'.*_c2t_wds.nii$'));
V=spm_vol(EPI);
mtx=spm_read_vols(V);
T=(T>threshold);
