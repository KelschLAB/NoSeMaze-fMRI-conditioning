function out = spm_dartel_norm_fun_mice_jr(job)
% Version JR:
% tpm (template) of MNI space is replaced by our own mice template (ln. 46)
...
K    = 6;
tpm  = '/home/jonathan.reinwald/ICON_Autonomouse/03-processed-data/03-MRI/04-helpers/02-TPM_Markus/4D.nii'%REPLACED by JR: fullfile(spm('Dir'),'tpm','TPM.nii');
