function [ Pout, finalBrainSize ] = ms_PCNN3D( P, BrSize )
...
if nargin <3
    if prod(voxdim)<10; flag.r=3; flag.p=5; else; flag.r=2; flag.p=3; end % r is for PCNN; p for morphological smooting; for anatomical 3/5 seems okay; for EPIs it's more 2/2-3
end
p=flag.p;
r=flag.r;
...
[S, Vproc] = ms_preprocImage(Mtx, V, voxdim);
