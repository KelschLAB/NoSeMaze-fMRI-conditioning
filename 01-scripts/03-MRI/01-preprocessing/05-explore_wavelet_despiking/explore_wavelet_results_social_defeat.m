% load filelist
if 1==1
    load('/home/jonathan.reinwald/ICON_Autonomouse/data/social_defeat/fMRI/filelists/filelist_ICON_social_defeat_jr.mat')
end
...
for subj=1:length(Pfunc_social_defeat);
    ...
    [fpath, fname, ext]=fileparts(Pfunc_social_defeat{subj});
    ...
    epiPrefsubj{2} = 'wave_10cons_med1000_msk_s6_wrst_a1_u_del5_';
    epiSuffsubj{2} = '_c1_c2t_wds';
    epiPrefsubj{3} = 'wave_10cons_med1000_msk_s6_wrst_a1_u_del5_';
...
%         protocol_dir = '/home/jonathan.reinwald/ICON_Autonomouse/data/social_defeat/fMRI/processed_protocol_files';
%         [fpath,fname,ext]=fileparts(Pfunc_social_defeat{subj});
...
% 
%         mask='/home/jonathan.reinwald/ICON_Autonomouse/data/social_defeat/fMRI/preprocessing/DARTEL/mask_template_6_polished.nii';
%         V_mask = spm_vol(mask);
