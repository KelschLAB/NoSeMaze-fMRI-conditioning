%% master_preprocess_protocol__social_hierarchy.m
%% 
...
protocol_dir='/zi-flstorage/data/Jonathan/ICON_Autonomouse/MRI/paradigm_social_hierarchy/protocol_files' % Files are manually controlled, including only protocol.mat-files with rhd-files
rhd_dir='/zi-flstorage/data/Jonathan/ICON_Autonomouse/MRI/paradigm_social_hierarchy/rhd_files'
outputdir='/zi-flstorage/data/Jonathan/ICON_Autonomouse/MRI/paradigm_social_hierarchy/processed_protocol_files'
mkdir(outputdir)
rootdir='/zi-flstorage/data/Jonathan/ICON_Autonomouse/MRI/paradigm_social_hierarchy'
...
% number of Volumes before deletion of dummy scans
nVolume = 775;

if 1==1
    process_protocol__social_hierarchy(protocollist,rhdlist,outputdir,rootdir,nVolume);
end;
