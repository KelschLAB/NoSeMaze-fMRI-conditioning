%% master_TC_analysis_social_2sessionscombined_jr.m
% Reinwald, Jonathan 06/2021
% "master_TC_analysis_social_2sessionscombined_jr" calculates the mean timecourse for specified regions
% of interest (ROIs)

% Preparation:
% Run master_GLM_residuals_social_2sessionscombined_jr.m before to create the residual nii-files
...
resultsDir = spm_select(1,'dir','Select Result Directory',{},'/home/jonathan.reinwald/ICON_Autonomouse/03-processed-data/03-MRI/06-social_2sessionscombined/08-TC_analysis/03-results');
...
% protocol directory
protocol_dir{1} = '/home/jonathan.reinwald/ICON_Autonomouse/03-processed-data/03-MRI/02-social_defeat/01-processed_protocol_files';
protocol_dir{2} = '/home/jonathan.reinwald/ICON_Autonomouse/03-processed-data/03-MRI/03-social_hierarchy/01-processed_protocol_files';
...
% select as many masks as you want
if 1==1
    Pmsk_all={'/home/jonathan.reinwald/ICON_Autonomouse/03-processed-data/03-MRI/06-social_2sessionscombined/05-GLM/03-results/HRFlongTC_withoutOnset_from2sHRF-GLM_EPI_wave_10cons_med1000_msk_s6_wrst_a1_u_despiked_del5____ROI_v1_v1___COV_v1_v1___ORTH_1___20-Jan-2023/secondlevel/CD1fam vs C57BL_BOTH/mask_activation_CD1FAMvsBOTH_T001.nii',.....
    '/home/jonathan.reinwald/ICON_Autonomouse/03-processed-data/03-MRI/06-social_2sessionscombined/05-GLM/03-results/HRFlongTC_withoutOnset_from2sHRF-GLM_EPI_wave_10cons_med1000_msk_s6_wrst_a1_u_despiked_del5____ROI_v1_v1___COV_v1_v1___ORTH_1___20-Jan-2023/secondlevel/CD1fam vs C57BL_BOTH/mask_deactivation_CD1FAMvsBOTH_T001.nii',.....   
    '/home/jonathan.reinwald/ICON_Autonomouse/03-processed-data/03-MRI/06-social_2sessionscombined/05-GLM/03-results/HRFlongTC_withoutOnset_from2sHRF-GLM_EPI_wave_10cons_med1000_msk_s6_wrst_a1_u_despiked_del5____ROI_v1_v1___COV_v1_v1___ORTH_1___20-Jan-2023/secondlevel/129sv vs C57BL_BOTH/mask_activation_129SVvsBOTH_T001.nii',.....
    '/home/jonathan.reinwald/ICON_Autonomouse/03-processed-data/03-MRI/06-social_2sessionscombined/05-GLM/03-results/HRFlongTC_withoutOnset_from2sHRF-GLM_EPI_wave_10cons_med1000_msk_s6_wrst_a1_u_despiked_del5____ROI_v1_v1___COV_v1_v1___ORTH_1___20-Jan-2023/secondlevel/129sv vs C57BL_BOTH/mask_deactivation_129SVvsBOTH_T001.nii',.....
    '/home/jonathan.reinwald/ICON_Autonomouse/03-processed-data/03-MRI/06-social_2sessionscombined/05-GLM/03-results/HRFlongTC_withoutOnset_from2sHRF-GLM_EPI_wave_10cons_med1000_msk_s6_wrst_a1_u_despiked_del5____ROI_v1_v1___COV_v1_v1___ORTH_1___20-Jan-2023/secondlevel/CD1unk vs C57BL_BOTH/mask_activation_CD1UNKvsBOTH_T001.nii',.....
    '/home/jonathan.reinwald/ICON_Autonomouse/03-processed-data/03-MRI/06-social_2sessionscombined/05-GLM/03-results/HRFlongTC_withoutOnset_from2sHRF-GLM_EPI_wave_10cons_med1000_msk_s6_wrst_a1_u_despiked_del5____ROI_v1_v1___COV_v1_v1___ORTH_1___20-Jan-2023/secondlevel/CD1unk vs C57BL_BOTH/mask_deactivation_CD1UNKvsBOTH_T001.nii',.....
...
%     {'/home/jonathan.reinwald/ICON_Autonomouse/03-processed-data/03-MRI/01-reappraisal/05-GLM/03-results/HRFlongTC_withoutOnset_from2sHRF-GLM_EPI_med1000_msk_s6_wrst_a1_u_del5____ROI_v24___COV_v1___ORTH_1___DERDISP0___20-Jan-2023/secondlevel/TP_NoPuff_Bl3_vs_TP_NoPuff_Bl1_11to40/mask_T001_ROI_v24.nii',...
...
%     };
% Pmsk_all={'/home/jonathan.reinwald/ICON_Autonomouse/03-processed-data/03-MRI/02-social_defeat/05-GLM/03-results/HRFlongTC_withoutOnset_from2sHRF-GLM_EPI_wave_10cons_med1000_msk_s6_wrst_a1_u_despiked_del5____ROI_v4___COV_v1___ORTH_1___20-Jan-2023/secondlevel_Diff_DavidsScore/CD1fam/mask_Diff_DavidsScore_T001_v4.nii',...
%     '/home/jonathan.reinwald/ICON_Autonomouse/03-processed-data/03-MRI/02-social_defeat/05-GLM/03-results/HRFlongTC_withoutOnset_from2sHRF-GLM_EPI_wave_10cons_med1000_msk_s6_wrst_a1_u_despiked_del5____ROI_v4___COV_v1___ORTH_1___20-Jan-2023/secondlevel_Diff_DavidsScore/CD1fam/mask_Diff_DavidsScore_T01_v4.nii',...
%     '/home/jonathan.reinwald/ICON_Autonomouse/03-processed-data/03-MRI/02-social_defeat/05-GLM/03-results/HRFlongTC_withoutOnset_from2sHRF-GLM_EPI_wave_10cons_med1000_msk_s6_wrst_a1_u_despiked_del5____ROI_v1___COV_v1___ORTH_1___20-Jan-2023/secondlevel_Diff_DavidsScore/CD1fam/mask_Diff_DavidsScore_T001_v1.nii',...
%     '/home/jonathan.reinwald/ICON_Autonomouse/03-processed-data/03-MRI/02-social_defeat/05-GLM/03-results/HRFlongTC_withoutOnset_from2sHRF-GLM_EPI_wave_10cons_med1000_msk_s6_wrst_a1_u_despiked_del5____ROI_v1___COV_v1___ORTH_1___20-Jan-2023/secondlevel_Diff_DavidsScore/CD1fam/mask_Diff_DavidsScore_T01_v1.nii',...
%     };
...
%         };   
    ...
    for Nmask = 1:(size(Pmsk,1)+1)
        ...
        for sess=sessions
            ...
            % get sessiondir ...
            [fpath,fname,ext]=fileparts(Pfunc_social_hierarchy{sess}); % Pfunc_social_defeat is only needed to define the animal
            ...
            % 2. find and load processed protocol file
            [fpath,fname,ext]=fileparts(Pfunc_social_hierarchy{sess});
            protocol_file_SD = dir([protocol_dir{1} filesep 'animal_' fname(5:6) filesep '*_new.mat']);
            clear events 
            load([protocol_file_SD.folder filesep protocol_file_SD.name]);
            events_SD = events;
            protocol_file_SH = dir([protocol_dir{2} filesep 'animal_' fname(5:6) filesep '*_new.mat']);
            clear events
            load([protocol_file_SH.folder filesep protocol_file_SH.name]);
            events_SH = events;      
            number_TRs_SD = 1095;
            %% !!!!!! CAVE: we only correct trial number and fv_on_del5 !!!!!
            for idx_ev = 1:length(events_SH)
                events_SH(idx_ev).fv_on_del5 = events_SH(idx_ev).fv_on_del5+number_TRs_SD*TR;
                events_SH(idx_ev).trial_num = events_SH(idx_ev).trial_num+length(events_SD);
            end
            clear events
            events = [events_SD(:);events_SH(:)];         
            ...
            if contains(covarSuffix,'v1')
                ...
                rp = SPM.xX.X(:,rp_xX);
                FD = [SNiP_framewise_displacement(rp(1:1095,1:6));SNiP_framewise_displacement(rp(1096:end,7:end))];
            ...
            tc_matrsess(4).mat(sess,:,:) = tc_matrsess_all(sess,contains({events.case_name},'C57Bl6 high'),:)
            tc_matrsess(4).mat_highres(sess,:,:) = tc_matrsess_all_highres(sess,contains({events.case_name},'C57Bl6 high'),:)
            tc_matrsess(4).mat_highres_spline(sess,:,:) = tc_matrsess_all_highres_spline(sess,contains({events.case_name},'C57Bl6 high'),:)
            tc_matrsess(4).mat_highres_lin(sess,:,:) = tc_matrsess_all_highres_lin(sess,contains({events.case_name},'C57Bl6 high'),:)
            tc_matrsess(4).odor = 'C57Bl6High';
            
            tc_matrsess(5).mat(sess,:,:) = tc_matrsess_all(sess,contains({events.case_name},'C57Bl6 low'),:)
            tc_matrsess(5).mat_highres(sess,:,:) = tc_matrsess_all_highres(sess,contains({events.case_name},'C57Bl6 low'),:)
            tc_matrsess(5).mat_highres_spline(sess,:,:) = tc_matrsess_all_highres_spline(sess,contains({events.case_name},'C57Bl6 low'),:)
            tc_matrsess(5).mat_highres_lin(sess,:,:) = tc_matrsess_all_highres_lin(sess,contains({events.case_name},'C57Bl6 low'),:)
            tc_matrsess(5).odor = 'C57Bl6Low';
            ...
            FD_matrsess(4).mat(sess,:,:) = FD_matrsess_all(sess,contains({events.case_name},'C57Bl6 high'),:)
            FD_matrsess(4).mat_highres(sess,:,:) = FD_matrsess_all_highres(sess,contains({events.case_name},'C57Bl6 high'),:)
            FD_matrsess(4).odor = 'C57Bl6High';
            
            FD_matrsess(5).mat(sess,:,:) = FD_matrsess_all(sess,contains({events.case_name},'C57Bl6 low'),:)
            FD_matrsess(5).mat_highres(sess,:,:) = FD_matrsess_all_highres(sess,contains({events.case_name},'C57Bl6 low'),:)
            FD_matrsess(5).odor = 'C57Bl6Low';
