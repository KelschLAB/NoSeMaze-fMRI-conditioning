%% master_plot_TC_heatmap_social_2sessionscombined_jr.m
...
% select input
inputDir = '/home/jonathan.reinwald/ICON_Autonomouse/03-processed-data/03-MRI/06-social_2sessionscombined/08-TC_analysis/03-results/HRFlongTC_withoutOnset_from2sHRF-GLM_EPI_wave_10cons_med1000_msk_s6_wrst_a1_u_despiked_del5____ROI_v99_v99___COV_v1_v1___ORTH_1___06-Feb-2023/meanTC';
subDir = dir(inputDir);
...
for subReg = 2:length(subDir)
    ...
    for subfig=1:4
        ...
        ax.YTick=[1:size(effectsize,1)];
        ax.YTickLabel={'129sv-CD1fam','129sv-CD1unk','129sv-High','129sv-Low','CD1fam-CD1unk','CD1fam-High','CD1fam-Low','CD1unk-High','CD1unk-Low','High-Low'};
