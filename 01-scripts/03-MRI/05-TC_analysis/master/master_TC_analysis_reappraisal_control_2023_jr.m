%% master_TC_analysis_reappraisal_control_2023_jr.m
...
HRF_onset = 'withoutOnset'; % 'withoutOnset'; %% CAVE: We do not convolve anything with the HRF (no ROIs, therefore, it should not matter here!!!)
...
resultsDir = '/home/jonathan.reinwald/ICON_Autonomouse/03-processed-data/03-MRI/07-reappraisal_control_2023/08-TC_analysis/03-results';
...
% Pmsk_all={'/home/jonathan.reinwald/ICON_Autonomouse/03-processed-data/03-MRI/01-reappraisal/06-FC/01-BASCO/cormat_v1/OB.nii',...
...
for Nmask = 1:(size(Pmsk,1)+1)
    ...
    for sess=sessions
        ...
        sessiondir = [firstleveldir filesep 'ZI_M' fname(5:11)];
        ...
        % select ...
        Pcur=spm_select('FpList', sessiondir ,['^4D_residuals_ZI_M' fname(5:11) '.nii']);
        ...
        if contains(covarSuffix,'v1')
            ...
            rp = SPM.xX.X(:,rp_xX);
            FD = SNiP_framewise_displacement_original(rp); % CAVE: 
        ...
        % DVARS
        load('/home/jonathan.reinwald/ICON_Autonomouse/04-outputs/03-MRI/07-reappraisal_control_2023/01-preprocessing/01-motion/DVARS/DVARS_info.mat');
