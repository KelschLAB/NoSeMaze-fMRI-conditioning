function meanTimeCourseAnalysis_originalTC_JR
...
outputdir='/home/jonathan.reinwald/Awake/TimeCourse_analysis/NORESIDUALS_noDetrending_noZtransformation';
...
cd('/home/jonathan.reinwald/Awake/atlas/REGIONS OF INTEREST/');
...
%     firstleveldir = '/home/jonathan.reinwald/Awake/stats_FirstLevel/FirstLevelResiduals_RP';
...
%     numbersess = numel(dirlist);
    ...
    for ix=2%array_valid_sessions(1:end)
        ...
        hold on
        title(['Rew - NonRew' fname_mask],'Interpreter','none');
        ...
        ylim1=max(mean(matrix_rew))-2*max(std(matrix_rew));
        ylim2=max(mean(matrix_rew))+2*max(std(matrix_rew));
        fill([0 0 1 1],[ylim1 ylim2 ylim2 ylim1],[0.5 0.5 0.5],'FaceColor',[0.5 0.5 0.5],'FaceAlpha',0.1,'EdgeAlpha',0)
        fill([2 2 3 3],[ylim1 ylim2 ylim2 ylim1],[0.5 0.5 0.5],'FaceColor',[0.5 0.5 0.5],'FaceAlpha',0.1,'EdgeAlpha',0)

        h.XLim=[-1 Nfr+1];
        h.YLim=[ylim1-1 ylim2+2];
        h.XLabel.String='Time (x1.2 s)';h.YLabel.String='BOLD SIGNAL';
    ...
    ylim1=max(mean(TOTALmean_nonrew))-2*max(std(TOTALmean_nonrew));
    ylim2=max(mean(TOTALmean_nonrew))+2*max(std(TOTALmean_nonrew));
    fill([0 0 1 1],[ylim1 ylim2 ylim2 ylim1],[0.5 0.5 0.5],'FaceColor',[0.5 0.5 0.5],'FaceAlpha',0.1,'EdgeAlpha',0)
    fill([2 2 3 3],[ylim1 ylim2 ylim2 ylim1],[0.5 0.5 0.5],'FaceColor',[0.5 0.5 0.5],'FaceAlpha',0.1,'EdgeAlpha',0)
    ...
    ylim1=max(mean(TOTALmean_nonrew_2))-2*max(std(TOTALmean_nonrew_2));
    ylim2=max(mean(TOTALmean_nonrew_2))+2*max(std(TOTALmean_nonrew_2));
    fill([0 0 1 1],[ylim1 ylim2 ylim2 ylim1],[0.5 0.5 0.5],'FaceColor',[0.5 0.5 0.5],'FaceAlpha',0.1,'EdgeAlpha',0)
    fill([2 2 3 3],[ylim1 ylim2 ylim2 ylim1],[0.5 0.5 0.5],'FaceColor',[0.5 0.5 0.5],'FaceAlpha',0.1,'EdgeAlpha',0)
    ...
    %     tt = text(2.5,1,'REWARD','HorizontalAlignment','center','FontWeight','bold');
    %
    %     ax=xlim([-1 Nfr+1]); ay=ylim([-0.8 1.2]);
    ...
    %
    %
    print(f4,'-dpdf',[newdir filesep 'Rew - ' fname_mask addon]);
    %     print(f2,'-dpdf',[newdir filesep '50 - ' fname_mask addon]);
    %     print(f3,'-dpdf',[newdir filesep '0 - ' fname_mask addon]);
    %     print(f4,'-dpdf',[newdir filesep 'AllOdors - ' fname_mask addon]);
    clear h
