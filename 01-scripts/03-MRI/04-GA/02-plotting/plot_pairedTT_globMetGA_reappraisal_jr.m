%% plot_pairedTT_globMetGA_reappraisal_jr.m
...
if separated_hemisphere==2
    inputDir = ['/home/jonathan.reinwald/ICON_Autonomouse/03-processed-data/03-MRI/01-reappraisal/07-GA/01-gstruct_files/' cormat_version filesep 'separated_v2_2023_hemisphere' filesep binarization_method '_' connectedness];
...
for mx = 1:length(minthr_ind_range)
    ...
    if separated_hemisphere==1
        outputDir = ['/home/jonathan.reinwald/ICON_Autonomouse/04-outputs/03-MRI/01-reappraisal/06-GA/' cormat_version filesep 'separated_hemisphere' filesep binarization_method '_' connectedness '/' name_TP1 'VS' name_TP2];
    elseif separated_hemisphere==0
        outputDir = ['/home/jonathan.reinwald/ICON_Autonomouse/04-outputs/03-MRI/01-reappraisal/06-GA/' cormat_version filesep 'combined_hemisphere' filesep binarization_method '_' connectedness '/' name_TP1 'VS' name_TP2];
    elseif separated_hemisphere==2
        outputDir = ['/home/jonathan.reinwald/ICON_Autonomouse/04-outputs/03-MRI/01-reappraisal/06-GA/' cormat_version filesep 'separated_v2_2023_hemisphere' filesep binarization_method '_' connectedness '/' name_TP1 'VS' name_TP2];
    end
