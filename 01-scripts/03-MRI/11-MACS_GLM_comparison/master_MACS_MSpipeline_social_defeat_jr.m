%% master_MACS_MSpipeline_social_defeat_jr.m
% MACS Toolbox: Model Space Pipeline

% modified by Jonathan Reinwald, 26.04.2023
...
% project directories
stat_dir = '/home/jonathan.reinwald/ICON_Autonomouse/03-processed-data/03-MRI/02-social_defeat/05-GLM/04-modelselection';
if exist(stat_dir)==0
    mkdir(stat_dir);
end
work_dir = '/home/jonathan.reinwald/ICON_Autonomouse/03-processed-data/03-MRI/02-social_defeat/05-GLM/03-results';

% list of subjects
subj_ids = {'ZI_M11' 'ZI_M12' 'ZI_M13' 'ZI_M14' 'ZI_M16' 'ZI_M17' 'ZI_M18' 'ZI_M19' 'ZI_M22' 'ZI_M23' 'ZI_M24' ...
    'ZI_M25' 'ZI_M26' 'ZI_M27' 'ZI_M30' 'ZI_M31' 'ZI_M32' 'ZI_M33' 'ZI_M34' 'ZI_M36' ...
    'ZI_M37' 'ZI_M39' 'ZI_M40' 'ZI_M41'};

% list of models
% mod_names = {'HRFlongTC_withoutOnset_from2sHRF-GLM_EPI_wave_10cons_med1000_msk_s6_wrst_a1_u_despiked_del5____ROI_v1___COV_v1___ORTH_1___20-Jan-2023'...
%     'HRFlongTC_withoutOnset_from2sHRF-GLM_EPI_wave_10cons_med1000_msk_s6_wrst_a1_u_despiked_del5____ROI_v2___COV_v1___ORTH_1___20-Jan-2023'...
%    'HRFlongTC_withoutOnset_from2sHRF-GLM_EPI_wave_10cons_med1000_msk_s6_wrst_a1_u_despiked_del5____ROI_v4___COV_v1___ORTH_1___20-Jan-2023'...
 %   'HRFphilipplebhardt-GLM_EPI_wave_10cons_med1000_msk_s6_wrst_a1_u_despiked_del5____ROI_v4___COV_v1___ORTH_1___24-Feb-2023'};
% mod_names = {'HRFlongTC_withoutOnset_from2sHRF-GLM_EPI_wave_10cons_med1000_msk_s6_wrst_a1_u_despiked_del5____ROI_v1___COV_v1___ORTH_1___20-Jan-2023'...
%     'HRFlongTC_withoutOnset_from2sHRF-GLM_EPI_wave_10cons_med1000_msk_s6_wrst_a1_u_despiked_del5____ROI_v4___COV_v1___ORTH_1___20-Jan-2023'};
mod_names = {'HRFlongTC_withoutOnset_from2sHRF-GLM_EPI_wave_10cons_med1000_msk_s6_wrst_a1_u_despiked_del5____ROI_v4___COV_v1___ORTH_1___20-Jan-2023',...
    'HRFlongTC_withoutOnset_from2sHRF-GLM_EPI_wave_10cons_med1000_msk_s6_wrst_a1_u_despiked_del5____ROI_v4___COV_v1___ORTH_1___28-Feb-2023'};

    % model space details
ms_name  =  'MACS';
ms_suff = '_I_v4__II_v4DispDeriv';
...
for i = 1:N
    for j = 1:M
        job.models{i}{j}{1} = strcat(work_dir,'/',mod_names{j},'/firstlevel/',subj_ids{i},'/','SPM.mat');
    end
end
...
for j = 1:M
    clear find_
    find_ROI_v = strfind(mod_names{j},'ROI_v');
    find_minus = strfind(mod_names{j},'-');
%     job.names{j} = [mod_names{j}(1:find_minus-1) mod_names{j}(find_ROI_v+3:find_ROI_v+6)];
    job.names{j} = [mod_names{j}(1:find_minus-1) mod_names{j}(find_ROI_v+3:end)];
end
