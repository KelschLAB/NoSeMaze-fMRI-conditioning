...
path_dir = '/home/jonathan.reinwald/ICON_Autonomouse/03-processed-data/03-MRI/01-reappraisal/09-seed_analysis/unsmoothed_cormat_v11_smoothed_cormat_v9/mask_activation_v22_Bl3vsBl1_T01/firstlevel/TPnoPuff11to40/fCC';
P1 = spm_select('FPList',path_dir,'^fCC_ZI*');
path_dir = '/home/jonathan.reinwald/ICON_Autonomouse/03-processed-data/03-MRI/01-reappraisal/09-seed_analysis/unsmoothed_cormat_v11_smoothed_cormat_v9/mask_activation_v22_Bl3vsBl1_T01/firstlevel/TPnoPuff81to120/fCC';
P2 = spm_select('FPList',path_dir,'^fCC_ZI*');
output_dir = fullfile('/home/jonathan.reinwald/ICON_Autonomouse/03-processed-data/03-MRI/01-reappraisal/09-seed_analysis/unsmoothed_cormat_v11_smoothed_cormat_v9/mask_activation_v22_Bl3vsBl1_T01/firstlevel','diffBl3vsBl1');
mkdir(output_dir);
...
output_dir_secondlevel = fullfile('/home/jonathan.reinwald/ICON_Autonomouse/03-processed-data/03-MRI/01-reappraisal/09-seed_analysis/unsmoothed_cormat_v11_smoothed_cormat_v9/mask_activation_v22_Bl3vsBl1_T01/','secondlevel','diffBl3vsBl1');
