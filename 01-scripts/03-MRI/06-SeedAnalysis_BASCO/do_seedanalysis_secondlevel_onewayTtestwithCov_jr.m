function do_seedanalysis_secondlevel_onewayTtestwithCov_jr(P_sc1, P_outputdir, Pmsk_general, contrast, covariate)

% Factorial Design Specification
matlabbatch{1}.spm.stats.factorial_design.dir = cellstr(P_outputdir);
matlabbatch{1}.spm.stats.factorial_design.des.t1.scans = cellstr(P_sc1);
% Define input
matlabbatch{1}.spm.stats.factorial_design.cov.c = covariate.val;
