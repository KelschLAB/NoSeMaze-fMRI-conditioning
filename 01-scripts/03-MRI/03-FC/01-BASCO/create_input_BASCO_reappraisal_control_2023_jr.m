function create_input_BASCO_reappraisal_control_2023_jr(Pfunc_all,input_dir,regressorsDir,epiPrefix,epiSuffix,regressorsSuffix,vname,HRF_name,despiked)
% 
...
for subj = 1:length(Pfunc_all)
    ...
    subjAbrev = ['ZI_' fname(4:find_(2)-1)];
