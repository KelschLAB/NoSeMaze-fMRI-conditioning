%% master_BASCO_reappraisal_control_2023_jr.m
...
vname = 'v6'; %% CAVE: check regressorsSuffix !!!
...
% epiPrefix = 'DVARSscrub_0_1_lin_wave_10cons_med1000new_msk_wrst_a1_u_despiked_del5_'; % Smoothed version for e.g. seedanalysis
% epiPrefix = 'wave_10cons_med1000new_msk_s6_wrst_a1_u_despiked_del5_'; % Smoothed version for e.g. seedanalysis
epiPrefix = 'wave_10cons_med1000new_msk_wrst_a1_u_despiked_del5_'; % unsmoothed version for e.g. seedanalysis
epiSuffix = '_c2t_wds';
...
if 1==0
    % Subscript
    despiked=1;
    create_input_BASCO_reappraisal_control_2023_jr(Pfunc_reappraisal,input_dir,regressorsDir,epiPrefix,epiSuffix,regressorsSuffix,vname,HRF_name,despiked);    
end
...
% Switch
if 1==0
    create_betaseries_BASCO_reappraisal_control_2023_jr(Pfunc_reappraisal,main_dir,vname);  
end
