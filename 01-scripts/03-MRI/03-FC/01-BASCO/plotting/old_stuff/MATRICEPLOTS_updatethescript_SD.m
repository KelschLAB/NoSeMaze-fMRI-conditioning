%% plot_cormat_BASCO_social_defeat_jr.m
...
%% Load filelist
if 1==1
    load('/zi-flstorage/data/Jonathan/ICON_Autonomouse/03-processed-data/03-MRI/02-social_defeat/03-filelists/filelist_ICON_social_defeat_jr.mat')
end

%% Define directories
% Working Directory
workdir = '/zi-flstorage/data/Jonathan/ICON_Autonomouse/03-processed-data/03-MRI/02-social_defeat/06-FC/01-BASCO/cormat_v4/beta4D';
% Output directory
outputdir = '/zi-flstorage/data/Jonathan/ICON_Autonomouse/04-outputs/03-MRI/02-social_defeat/04-FC/01-BASCO/01-Cormat';
mkdir(outputdir);
...
if 1==1
    for ix = 1:size(cormat_files,1)
        ...
        if 1==1
            ...
            print('-dpsc',fullfile([outputdir filesep],['MeanCormatALLConditions_' wd_name '_' date '.ps']) ,'-r400','-append','-bestfit')
        end
    end
end
