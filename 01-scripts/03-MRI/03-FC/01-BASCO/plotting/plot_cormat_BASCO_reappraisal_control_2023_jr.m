%% plot_cormat_BASCO_reappraisal_control_2023_jr.m
% Jonathan Reinwald, 09/2023
% Script for plotting:
% -
...
% Working Directory
workdir = ['/home/jonathan.reinwald/ICON_Autonomouse/03-processed-data/03-MRI/07-reappraisal_control_2023/06-FC/01-BASCO/' cormat_selection '/beta4D/' atlasHemisphere_selection '_hemisphere'];
...
% Output directory
outputdir = ['/zi-flstorage/data/jonathan/ICON_Autonomouse/04-outputs/03-MRI/07-reappraisal_control_2023/04-FC/01-BASCO/01-Cormat/' cormat_selection '/' atlasHemisphere_selection '_hemisphere'];
...
if 1==1
    for ix = 10%1:size(cormat_files,1)
        % Load Cormat_1
