%% master_NBS_pairedttest_reappraisal_jr.m
...
%% trial_selection
trial_selection{1}='TPnoPuff81to120'; trial_selection{2}='Odor81to120';
trial_selection{3}='TPnoPuff11to40'; trial_selection{4}='Odor11to40';
