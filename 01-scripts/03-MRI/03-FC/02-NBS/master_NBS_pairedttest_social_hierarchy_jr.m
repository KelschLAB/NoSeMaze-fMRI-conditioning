%% master_NBS_pairedttest_social_hierarchy_jr.m
...
%% Define directories
% Working Directory
inputdir = ['/home/jonathan.reinwald/ICON_Autonomouse/03-processed-data/03-MRI/03-social_hierarchy/06-FC/01-BASCO/' cormat_selection '/beta4D/' atlasHemisphere_selection '_hemisphere'];
% Output directory
outputdir = ['/home/jonathan.reinwald/ICON_Autonomouse/04-outputs/03-MRI/03-social_hierarchy/04-FC/02-NBS/' cormat_selection '/' atlasHemisphere_selection '_hemisphere'];
if ~exist(outputdir)
    mkdir(outputdir);
end
...
%% trial_selection
trial_selection{1}='C57Bl6-High'; trial_selection{2}='C57Bl6-Low';
