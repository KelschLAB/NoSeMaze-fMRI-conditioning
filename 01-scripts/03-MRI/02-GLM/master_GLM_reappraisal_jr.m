...
% regressorsSuffix_sel{2} = '_v80.mat';
...
%     HRF_onset = 'hrf_philipplebhardt';
    ...
    % selection of EPI
    %     epiPrefix = 'DVARSscrub_0_1_lin_wave_10cons_med1000_msk_s6_wrst_a1_u_del5_';
    ...
    resultsDir = '/home/jonathan.reinwald/ICON_Autonomouse/03-processed-data/03-MRI/01-reappraisal/05-GLM/03-results';
    ...
    if 1==1
        ...
        for subj = 1:length(subjects)
            ...
            if contains(epiPrefix,'wave')
                find_ICON = findstr(fdir,'ICON');
                Pfuncall = spm_select('ExtFPlist',['/zi-flstorage/data/jonathan/' fdir(find_ICON:end) filesep 'wavelet'],['^' epiPrefix fname epiSuffix '.nii'],[1:2500]);
