...
regressorsSuffix_sel{1} = '_v13.mat';
% regressorsSuffix_sel{2} = '_v2.mat';
% regressorsSuffix_sel{3} = '_v4.mat';
% regressorsSuffix_sel{4} = '_v6.mat';
% regressorsSuffix_sel{5} = '_v7.mat';
% regressorsSuffix_sel{6} = '_v8.mat';
...
%         epiSuffix = '_c1_c2t';
    ...
    resultsDir = '/home/jonathan.reinwald/ICON_Autonomouse/03-processed-data/03-MRI/02-social_defeat/05-GLM/03-results';
    % outputDirName
    ...
    %         outputDirName = ['HRF' HRF_TCbased '_' HRF_infopath epiSuffix(end-4:end) '_EPI_' epiPrefix(1:end) '___ROI_' regressorsSuffix(2:end-4) '___COV_' covarSuffix(2:3) '___ORTH_' num2str(orth)  '___' date];
    %     end
    ...
    if 1==1
        ...
        for subj = 1:length(subjects)
            tic
            % pre-clearing
            clear regressors Pfuncall ROI COV
