...
ExplVar(13).name = 'PCA1_Vid';
ExplVar(13).values = T.PCA1_Vid;
...
ExplVar(14).name = 'PCA1_vidDS';
ExplVar(14).values = T.PCA1_vidDS;
...
ExplVar(15).name = 'PCA2_vidDS';
ExplVar(15).values = T.PCA2_vidDS;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
for varIdx = 14:15%:length(ExplVar)
