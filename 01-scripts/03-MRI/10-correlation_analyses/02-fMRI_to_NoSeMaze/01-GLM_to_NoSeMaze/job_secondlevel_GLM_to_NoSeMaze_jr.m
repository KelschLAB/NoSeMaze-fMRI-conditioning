%-----------------------------------------------------------------------
% Job saved on 22-Mar-2018 14:36:29 by cfg_util (rev $Rev: 6134 $)
% spm SPM - SPM12 (6225)
...
%%
matlabbatch{1}.spm.stats.factorial_design.cov.c = [1:10];
matlabbatch{1}.spm.stats.factorial_design.cov.cname = 'test';
