function [pupil_dia,lid_dia] = pupil_load_and_fit_ellipse_fMRI_2022(Videolist_csv, Videolist, likelihood_threshold_pupil, likelihood_threshold_lid,  savedir, plotter)
...
for vid = 1:numel(Videolist_csv)
    ...
    nanvec_LidPosition_EastOrWest=find(sum(~isnan(coords_array_lid(:,[5,6,13,14])),2));
