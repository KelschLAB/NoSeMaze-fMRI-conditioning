function  [num_amplifier_samples, sample_rate, num_board_dig_in_channels, num_amplifier_channels,num_board_adc_channels] = LengthRhd(path, file)


%modified 12.03.2016
%now just returns the number of samples, sample rate, numbers of amplifier and digital channels in the rhd-file specified as input.
...
% 
%     t_amplifier =int32(zeros(1, num_amplifier_samples));
% 
%     amplifier_data = single(zeros(num_amplifier_channels, num_amplifier_samples));
...
%     board_adc_data = uint16(zeros(num_board_adc_channels, num_board_adc_samples));
%     board_dig_in_data = int8(zeros(num_board_dig_in_channels, num_board_dig_in_samples));
%     board_dig_in_raw = uint16(zeros(1, num_board_dig_in_samples));
