...
prefix = '/home/jonathan.reinwald/ICON_Autonomouse/02-raw-data/04-pupil/04-trained_network_David'
...
vidlist = (os.path.join(prefix, 'vidList.txt'))#r'C:/MirkoDLC/vidlist.txt' r'/home/jonathan.reinwald/ICON_Autonomouse/02-raw-data/04-pupil/04-trained_network_David/vidList.txt'#(
