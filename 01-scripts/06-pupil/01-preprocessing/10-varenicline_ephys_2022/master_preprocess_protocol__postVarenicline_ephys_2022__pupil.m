%% master_preprocess_protocol__postVarenicline_ephys_2022__pupil.m
%% 
...
% Info on varenicline
% 160 odor trials, 160 laser trials, alternating
% odor: YlangYlang or Jasmin, 2.4 s duration, channel 2
% laser: laser 0.005 s, channel 1
...
protocol_dir='/home/jonathan.reinwald/ICON_Autonomouse/02-raw-data/04-pupil/08-varenicline_ephys_2022/01-protocol_files/post_varenicline' % Files are manually controlled, including only protocol.mat-files with rhd-files
rhd_dir='/home/jonathan.reinwald/ICON_Autonomouse/02-raw-data/04-pupil/08-varenicline_ephys_2022/02-rhd_files/post_varenicline'
outputdir='/home/jonathan.reinwald/ICON_Autonomouse/03-processed-data/04-pupil/08-varenicline_ephys_2022/01-processed_protocol_files'
mkdir(outputdir)
...
if 1==1
    process_protocol__postVarenicline_ephys_2022__pupil(protocollist,rhdlist,outputdir,rootdir);
end
