%% master_process_pupil_reappraisal_NoSeMaze_2023_jr.m
...
load(fullfile(vid_mainDir,'vid_pathlist_reappraisal_NoSeMaze_2023.mat'),'vid_path_list');
load(fullfile(protocol_mainDir,'protocol_pathlist_reappraisal_NoSeMaze_2023.mat'),'protocol_path_list');
...
if 1==0
    ...
    save(fullfile(vid_mainDir,'pupil_dia_scrubbed.mat'),'pupil_dia_scrubbed','lid_dia','lid_dia_v2');
end
