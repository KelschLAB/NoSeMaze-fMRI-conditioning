function  [amplifier_data, board_dig_in_data, board_adc_data, t_amplifier, meta, sample_rate] = IntanImport(file, path)
...
num_amplifier_samples = 60 * floor(num_data_blocks);
num_aux_input_samples = 15 * num_data_blocks;
num_supply_voltage_samples = 1 * num_data_blocks;
num_board_adc_samples = 60 * num_data_blocks;
num_board_dig_in_samples = 60 * floor(num_data_blocks);%all floor is MOD
...
%     fprintf(1, 'Allocating memory for data...\n');
    ...
    amplifier_data = uint16(zeros(num_amplifier_channels, num_amplifier_samples));
...
meta.notes=notes;
meta.frequency_parameters=frequency_parameters;

meta.num_amplifier_channels=num_amplifier_channels;
meta.num_aux_input_channels=num_aux_input_channels;
meta.num_supply_voltage_channels = num_supply_voltage_channels;
meta.num_board_adc_channels = num_board_adc_channels;
meta.num_board_dig_in_channels = num_board_dig_in_channels;
meta.num_board_dig_out_channels = num_board_dig_out_channels;
