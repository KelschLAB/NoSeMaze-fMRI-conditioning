%% master_preprocess_protocol__social_defeat_ephys_2022__pupil.m
%% 
...
protocol_dir='/home/jonathan.reinwald/ICON_Autonomouse/02-raw-data/04-pupil/07-social_defeat_ephys_2022/01-protocol_files' % Files are manually controlled, including only protocol.mat-files with rhd-files
rhd_dir='/home/jonathan.reinwald/ICON_Autonomouse/02-raw-data/04-pupil/07-social_defeat_ephys_2022/02-rhd_files'
outputdir='/home/jonathan.reinwald/ICON_Autonomouse/03-processed-data/04-pupil/07-social_defeat_ephys_2022/01-processed_protocol_files'
mkdir(outputdir)
...
if 1==1
    process_protocol__reappraisal_ephys_2022__pupil(protocollist,rhdlist,outputdir,rootdir);
end
