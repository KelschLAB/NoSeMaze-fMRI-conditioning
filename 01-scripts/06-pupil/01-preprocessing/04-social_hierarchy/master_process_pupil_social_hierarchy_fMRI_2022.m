%% master_process_pupil_social_hierarchy_fMRI_2022.m
...
load(fullfile(vid_mainDir,'vid_pathlist_social_hierarchy.mat'),'vid_path_list');
load(fullfile(protocol_mainDir,'protocol_pathlist_social_hierarchy.mat'),'protocol_path_list');
