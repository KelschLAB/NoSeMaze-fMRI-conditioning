%% master_process_pupil_160TrialsNeroli.m
...
vid_mainDir = '/zi-flstorage/data/jonathan/ICON_Autonomouse/02-raw-data/04-pupil/06-160TrialsNeroli_ephys_2022/03-videos_pupil';
protocol_mainDir = '/zi-flstorage/data/jonathan/ICON_Autonomouse/03-processed-data/04-pupil/06-160TrialsNeroli_ephys_2022/01-processed_protocol_files';

% Load video pathlist and protocol pathlist
load(fullfile(vid_mainDir,'vid_pathlist_160TrialsNeroli_ephys_2022.mat'),'vid_path_list');
load(fullfile(protocol_mainDir,'protocol_pathlist_160TrialsNeroli_ephys_2022.mat'),'protocol_path_list');
...
if 1==0
    ...
    save(fullfile(vid_mainDir,'pupil_dia_NEW.mat'),'pupil_dia','lid_dia');
end
